 ...
 * company/chat payloads into the browser console of a production site and
 * buried real warnings. Every console call in this app now goes through this
 * module, and `no-console` in `.eslintrc.cjs` keeps it that way.
 *
