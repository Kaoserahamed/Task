      ...
      questions: [
        {
          ...
          answer:
            "We recommend booking at least 3-4 months in advance for our most popular tours, especially during peak season (June-September). This ensures you get your preferred dates and accommodations. However, we occasionally have last-minute availability, so it's always worth checking with us.",
        },
        {
          id: 'booking2',
          question: 'What payment methods do you accept?',
          answer:
            'We accept all major credit cards (Visa, MasterCard, American Express), PayPal, bank transfers, and various digital payment options. All payments are processed securely through our encrypted payment gateway.',
        },
        {
          id: 'booking3',
          question: 'Is there a deposit required to secure my booking?',
          answer:
            'Yes, a 25% non-refundable deposit is required to confirm your booking. The remaining balance is due 30 days before your tour start date. For bookings made less than 30 days before departure, full payment is required at the time of booking.',
        },
        {
          id: 'booking4',
          question: 'Can I reserve now and pay later?',
          answer:
            'We offer a 48-hour hold on reservations without payment, which allows you time to make travel arrangements. After 48 hours, a deposit is required to confirm your booking.',
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            'Our standard tours typically have 8-12 participants, ensuring a personalized experience while still enjoying the social aspects of group travel. Some specialized tours may have smaller groups of 4-6 people. Private tours are also available for families or friend groups who prefer to travel exclusively together.',
        },
        {
          id: 'tours2',
          question: 'Are your tours suitable for children?',
          answer:
            'Most of our tours are designed for adults, but we do offer family-friendly tours specifically tailored for travelers with children. These tours include activities appropriate for various age groups and accommodations suitable for families. The minimum age requirement varies by tour, so please check the specific tour details or contact us for more information.',
        },
        {
          id: 'tours3',
          question: 'What is the physical fitness level required for your tours?',
          answer:
            'Our tours vary in physical intensity. Each tour description includes a fitness level indicator: Easy (suitable for most people with basic mobility), Moderate (requires ability to walk 3-5 miles daily on varied terrain), Challenging (includes longer hikes, possibly at elevation or in variable conditions), and Strenuous (designed for experienced hikers/trekkers). Please review these requirements carefully before booking.',
        },
        {
          id: 'tours4',
          question: 'Do you offer customized or private tours?',
          answer:
            "Yes! We specialize in creating customized itineraries for private groups. Whether you're traveling with family, friends, or colleagues, we can design a tour that matches your interests, timeline, and preferences. Private tours offer flexibility in scheduling, accommodations, and activities.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            "A detailed packing list is provided in your pre-departure information packet, which you'll receive after booking. Generally, we recommend layered clothing, comfortable walking shoes, weather-appropriate gear, personal medications, and travel documents. Specialized equipment required for certain activities (like hiking poles or snorkeling gear) may be provided depending on the tour.",
        },
        {
          id: 'prep2',
          question: 'Do I need travel insurance?',
          answer:
            'Yes, comprehensive travel insurance is mandatory for all participants. Your policy must cover emergency medical treatment, evacuation, trip cancellation, and lost luggage. We recommend purchasing insurance as soon as you book your tour. We can recommend reliable providers if needed.',
        },
        {
          id: 'prep3',
          question: 'Are visas required for your tours?',
          answer:
            'Visa requirements depend on your nationality and the destination countries included in your tour. It is your responsibility to check visa requirements and obtain necessary visas before departure. We provide general information about visa requirements in our tour documentation, but requirements can change, so we recommend checking with the relevant embassies or consulates for the most current information.',
        },
        {
          id: 'prep4',
          question: 'What vaccinations are required?',
          answer:
            "Vaccination requirements vary by destination. We recommend consulting with a travel health specialist or your physician at least 6-8 weeks before departure. They can advise on necessary vaccinations and preventive medications based on your specific health needs and the countries you'll be visiting.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            'Our standard cancellation policy is as follows: Cancellations 60+ days before departure: Full refund minus deposit; 30-59 days: 50% refund; 15-29 days: 25% refund; Less than 15 days: No refund. We strongly recommend comprehensive travel insurance that includes cancellation coverage for unforeseen circumstances.',
        },
        {
          id: 'cancel2',
          question: 'Can I transfer my booking to another person?',
          answer:
            "Yes, you may transfer your booking to another person if you are unable to travel. A transfer fee of $100 applies, and the new traveler must accept and meet all tour requirements. Transfer requests must be submitted in writing at least 30 days before departure, along with the new traveler's details.",
        },
        {
          id: 'cancel3',
          question: 'What happens if you cancel the tour?',
          answer:
            'In the rare event that we must cancel a scheduled tour (due to insufficient participants, safety concerns, or force majeure events), you will be offered the choice of a full refund, credit toward a future tour, or an alternative tour if available. We are not responsible for additional expenses incurred in preparing for the tour (e.g., non-refundable airfare), which is why travel insurance is essential.',
        },
        {
          id: 'cancel4',
          question: 'Can I change my tour dates after booking?',
          answer:
            'Date changes are subject to availability and may incur a rebooking fee of $75. Changes requested less than 60 days before departure are treated as a cancellation and new booking, subject to our standard cancellation terms. We try to be flexible but cannot guarantee availability on alternative dates, especially during peak season.',
        },
      ],
    },
  ];
    ...
    <div className="faq-container">
      ...
      <div className="faq-contact">
        ...
        <p>
          ...
          Contact us at <a href="mailto:support@yourtourwebsite.com">support@yourtourwebsite.com</a>{' '}
          or call us at <a href="tel:+11234567890">+1 (123) 456-7890</a>.
        </p>
      </div>
