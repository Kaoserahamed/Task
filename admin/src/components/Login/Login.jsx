...
const Login = () => {
  ...
  return (
    <div className="auth-container">
      ...
      >
        <p
          style={{ fontSize: '0.9rem', fontWeight: '600', color: '#92400e', marginBottom: '10px' }}
        >
        ...
        <p style={{ fontSize: '0.85rem', color: '#78350f', margin: 0 }}>
          Email: <strong>{DEMO_ADMIN_EMAIL || 'set REACT_APP_DEMO_ADMIN_EMAIL'}</strong> | Password:{' '}
          <strong>{DEMO_ADMIN_PASSWORD ? '••••••••' : 'set REACT_APP_DEMO_ADMIN_PASSWORD'}</strong>
        </p>
      </div>
      ...
      <p>For testing purposes, use the demo credentials above.</p>
    </div>
  );
};
